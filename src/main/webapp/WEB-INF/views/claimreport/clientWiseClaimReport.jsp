			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Employee Client wise Claim Report</h5>
					...
					<div class="card-body">
						...
						<form
							action="${pageContext.request.contextPath}/clientWiseClaimReport"
							...
							<div class="form-group row">
								...
								<c:if test="${clientwisereportlist.size()>0}">
									<button type="button" class="btn bg-blue ml-3 legitRipple"
										id="submtbtn"
										onclick="getProgReport(0,'exelForClientWiseClaim')">
							...
							<div class="table-responsive">
								<table
									...
									<tbody>
										...
										<c:forEach items="${clientwisereportlist}"
											var="clientwisereportlist" varStatus="count">
											<tr>

												<td>${count.index+1}</td>
												<td>${clientwisereportlist.custName}</td>
												<td style="text-align: right;">${clientwisereportlist.claimAmount}</td>

											</tr>

											<c:set value="${total+clientwisereportlist.claimAmount}"
												var="total"></c:set>
										</c:forEach>
										<c:if test="${clientwisereportlist.size()>0}">
											<tr>
