			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Employee Type wise Claim Report</h5>
					...
					<div class="card-body">
						...
						<form
							action="${pageContext.request.contextPath}/emptypewisereport"
									...
									<thead>
										<tr class="bg-blue">
											...
											<c:forEach items="${claimTypelist}" var="claimTypelist">
												<th>${claimTypelist.claimTypeTitle}</th>
											</c:forEach>
											<th>Total</th>
										</tr>
									</thead>
											...
											<tr>
												...
												<c:forEach items="${claimTypelist}" var="claimTypelist">
													<c:forEach items="${list.list}" var="detailList">
														<c:if
															test="${claimTypelist.claimTypeId==detailList.typeId}">
