				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="card">
							...
							<table width="100%">
							<tr width="100%">
								<td width="60%"><h5 class="card-title">Add KPI Review</h5></td>
								<td width="40%" align="right">
							  
								 <a
									href="${pageContext.request.contextPath}/showAddKpi?kraId=${editKra.exVar3}"
									class="breadcrumb-elements-item">
										<button type="button" class="btn btn-primary">KPi List </button>
								</a> </td>
							</tr>
						</table>
						</div>
							...
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" id="empName"
											value="${editKpi.kpiTitle}" name="lvsName" autocomplete="off"
											onchange="trim(this)" readonly>
								...
								<hr>
								<form
									action="${pageContext.request.contextPath}/submitKpiReview"
								...
								<h6 class="card-title">KPI Review List</h6>
								...
								<div class="table-responsive">
									<table
										...
										<tbody>
											<c:forEach items="${kpiReviewList}" var="kpiReviewList"
												varStatus="count">
												<tr>
													<td>${count.index+1}</td>
		...
		$(document).ready(function($) {
			...
			$("#submitInsertLeave").submit(function(e) {
				...
				if (!$("#kpi_review").val()) {
					...
					$("#error_kpi_review").show()
					//return false;
				} else {
					$("#error_kpi_review").hide()
				}
