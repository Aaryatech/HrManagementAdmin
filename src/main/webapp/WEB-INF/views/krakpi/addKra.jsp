					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<hr>
								<form action="${pageContext.request.contextPath}/insertKRA"
									...
									<div class="form-group row">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control"
												placeholder="KRA" id="kra_title" name="kra_title"
									...
									<input type="hidden" class="form-control numbersOnly"
										id="empId" value="${empInfo.empId}" name="empId"> 
										
										<input type="hidden" class="form-control numbersOnly"
										id="finYrId" value="${finYr.finYrId}" name="finYrId">  
