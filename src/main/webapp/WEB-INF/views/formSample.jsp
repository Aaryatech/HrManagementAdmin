		...
		<div class="content-wrapper">
			...
			<div class="content">
			                	...
			                	<form action="#">
									...
									<div class="form-group row mb-0">
										<div class="col-lg-10 ml-lg-auto">
											<button type="submit" class="btn btn-light legitRipple">Cancel<div class="legitRipple-ripple" style="left: 62.0495%; top: 68.4211%; transform: translate3d(-50%, -50%, 0px); transition-duration: 0.15s, 0.5s; width: 219.85%;"></div></button>
				...
				<div class="card">
					...
					<table class="table table-bordered table-hover datatable-highlight1 datatable-button-html5-basic  datatable-button-print-columns1" id="printtable1">
						<thead>
							<tr class="bg-blue">
								<th>First Name</th>
								<th>Last Name</th>
				...
				<div class="card">
					...
					<table class="table table-bordered table-hover   datatable-fixed-left"  >
						<thead>
					        <tr class="bg-blue">
					            <th>First name</th>
					            <th>Last name</th>
