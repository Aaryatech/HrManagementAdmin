			...
			<%-- <div class="page-header page-header-light">
				...
				<div
					...
					<div class="breadcrumb justify-content-center">
						<a href="${pageContext.request.contextPath}/showEmpDeptList"
							class="breadcrumb-elements-item"> Employee Department List</a>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="card">
 						...
 						<table width="100%">
							<tr width="100%">
								<td width="60%"><h5 class="card-title">Edit Employee Department</h5></td>
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/submitEditEmpDept"
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"
												...
												name="deptName" autocomplete="off" onchange="trim(this)" value="${editEmpDept.empDeptName}">
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"
												...
												name=deptShortName autocomplete="off" onchange="trim(this)" value="${editEmpDept.empDeptShortName}"
												maxlength="5"> <span
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<textarea rows="3" cols="3" class="form-control"
												...
												name="remark">${editEmpDept.empDeptRemarks}</textarea>
									...
									<div class="form-group row mb-0">
										<div class="col-lg-10 ml-lg-auto">
											...
											<a href="${pageContext.request.contextPath}/showEmpDeptList"><button
	...
	<script>
		...
		$(document).ready(function($) {
			...
			$("#submitInsertEmpDept").submit(function(e) {
				...
				if (!$("#deptShortName").val()) {

					isError = true;

					$("#error_deptShortName").show()

				} else {
					$("#error_deptShortName").hide()
				}
