		...
		<div class="content-wrapper">
			...
			<%-- 	<div
					...
					<div class="breadcrumb justify-content-center">
						<a href="${pageContext.request.contextPath}/showEmpCatList"
							class="breadcrumb-elements-item"> Employee Category List</a>
					...
					<div class="col-md-12">
						...
						<div class="card">
							<!-- <div class="card-header header-elements-inline">
								<h6 class="card-title">Add Employee Category</h6>
 						...
 						<table width="100%">
							<tr width="100%">
								<td width="60%"><h5 class="card-title">Add Employee Category</h5></td>
								...
								<form
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"
												...
												name="catName" autocomplete="off" onchange="trim(this)" value="${editEmpCategory.empCatName}">
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"
												...
												name="catShortName" autocomplete="off" onchange="trim(this)" value="${editEmpCategory.empCatShortName}"
												maxlength="5"> <span
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<textarea rows="3" cols="3" class="form-control"
												...
												name="remark"> ${editEmpCategory.empCatRemarks}</textarea>
									...
									<div class="form-group row mb-0">
										<div class="col-lg-10 ml-lg-auto">
											...
											<a href="${pageContext.request.contextPath}/showEmpCatList"><button
...
function checkSame(){
	...
	<script>
		...
		$(document).ready(function($) {
			...
			$("#submitInsertEmpCat").submit(function(e) {
				var isError = false;
				var errMsg = "";
				...
				if (!$("#catShortName").val()) {
					...
					$("#error_catShortName").show()

				} else {
					$("#error_catShortName").hide()
				}
