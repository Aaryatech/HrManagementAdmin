					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-header header-elements-inline">
								<table width="100%">
									<tr width="100%">
										<td width="60%"><h5 class="card-title">
												Edit Leave Structure
												<h5></td>
										<td width="40%" align="right"><a
											href="${pageContext.request.contextPath}/showLeaveStructureList"
											class="breadcrumb-elements-item">
												<button type="button" class="btn btn-primary">
													Leave Structure List</button>
										</a></td>
									</tr>
								</table>
							</div>
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/editInsertLeaveSummary"
									...
									<hr>
									<div class="form-group row">
										<strong> Leaves Type <span style="color: red">*
										</span>:
										</strong>
									</div>
