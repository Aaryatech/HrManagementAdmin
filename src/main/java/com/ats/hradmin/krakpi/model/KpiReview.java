...
public class KpiReview {
	...
	public String toString() {
		return "KpiReview [kpiReviewId=" + kpiReviewId + ", kpiId=" + kpiId + ", review=" + review + ", delStatus="
				...
				+ exVar1 + ", exVar2=" + exVar2 + ", exVar3=" + exVar3 + ", isError=" + isError + ", getKpiReviewId()="
				+ getKpiReviewId() + ", getKpiId()=" + getKpiId() + ", getReview()=" + getReview() + ", getDelStatus()="
