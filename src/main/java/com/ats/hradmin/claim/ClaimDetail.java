...
public class ClaimDetail {
	...
	public String toString() {
		return "ClaimDetail [claimId=" + claimId + ", claimTypeId=" + claimTypeId + ", claimAmount=" + claimAmount
				...
				+ ", exVar3=" + exVar3 + ", claimTypeTitle=" + claimTypeTitle + ", claimTypeTitleSshort="
				+ claimTypeTitleSshort + ", getClaimId()=" + getClaimId() + ", getClaimTypeId()=" + getClaimTypeId()
				...
				+ getClaimTypeTitleSshort() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
