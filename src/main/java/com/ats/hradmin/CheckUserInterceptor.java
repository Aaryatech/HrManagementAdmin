...
public class CheckUserInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		// System.err.println("max interval is "
		...
		if (!path.equalsIgnoreCase("/sessionTimeOut") || path.startsWith("/resources")) {
			...
			try {
				if (request.getServletPath().equals("/") || request.getServletPath().equals("/loginProcess")
						...
						|| request.getServletPath().equals("/showForgotPass")
						|| request.getServletPath().equals("/checkUserPassword")
						|| request.getServletPath().equals("/changePassIntialLogin")
						|| request.getServletPath().equals("/submitPassword")) { // ||request.getServletPath().equals("/logout")
